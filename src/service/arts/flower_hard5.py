from src.service.art_canvas import Canvas, extractType2, extractType5
...
def get(type : int) -> Canvas:
    n_flower = 5
    oShapeType, isRotate = extractType2(type, 3**5, 2)
    oShape1, oShape2, oShape3, oShape4, oShape5 = extractType5(oShapeType, 3, 3, 3, 3, 3)
    oShape = [oShape1, oShape2, oShape3, oShape4, oShape5]
